...
/// Outline/glow na cor da pasta + adapta texto via paleta.
/// Suporta bg sólido "solid:<hex>" e imagens.
class NoteCard extends StatelessWidget {
  final Note note;
  final VoidCallback onTap;
  final Color color; // cor da pasta
  ...
  Widget build(BuildContext context) {
    ...
    final solid = parseSolid(note.bgKey);
    ...
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(color: color.withOpacity(.35), blurRadius: 12)],
        ),
        child: Card(
          elevation: 0,
          color: cardFill,
                  ...
                  children: [
                    Text(note.title,
                      ...
                      style: Theme.of(context).textTheme.titleMedium?.copyWith(
                        fontWeight: FontWeight.w900, color: pal.title,
                      ),
                    ),
                    ...
                    Flexible(
                      child: Text(
                        ...
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: pal.body),
                      ),
                    ),
                  ],
                ),
